...
const NewMarriageCertificateImageScreen = ({navigation}) => {
  ...
  const uploadMedia = async() => {
    ...
    try {
        ...
        Alert.alert("Marriage certificate has been uploaded successfully!!!")
  ...
  const deleteImage = () => {
    ...
    deleteObject(deleteRef).then(async() => {
        ...
        setUrl(null)
        // navigation.navigate("MarriageCertificateImageScreen")
  ...
  return (
    <View style={{flex:1, alignItems:'center', justifyContent:'space-between', flexDirection:'column', padding:20}}>
        ...
        <View style={{width:'100%', alignItems:'center', flexDirection:'row', justifyContent:'space-between'}}>
            ...
            <Text style={{fontSize:18, fontWeight:'bold', color:COLORS.main, marginRight:10}}>Marriage Certificate </Text>
        </View>
            ...
            ?
              ...
              <View style={{width:'100%', height:'100%', alignItems:'center', justifyContent:'center'}}>
                <Text style={{color:'green'}}>Image Loading...</Text>
              </View>
            :
        ...
        <View style={{width:'100%', alignItems:'center', justifyContent:'center', paddingBottom:100}}>
          ...
          {url && 
            ...
            <Pressable 
            onPress={() => navigation.navigate("NewDocumentsAvailableScreen")}
            style={{ 
                alignItems:'center', 
                flexDirection:'row', 
                padding:10, 
...
export default NewMarriageCertificateImageScreen
