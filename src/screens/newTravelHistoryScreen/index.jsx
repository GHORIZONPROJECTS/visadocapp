...
export default function NewTravelHistoryScreen({ navigation }) {
      ...
      const handleMyTravel = async() => {
        ...
        if (travelled === 'travelled' && haveRelative === 'haveRelative' && refused === 'refused') {
            ...
            try {
              ...
              navigation.navigate("NewDocumentsAvailableScreen");
     ...
     <View style={{marginBottom:20}}>
        ...
        {travelled === 'travelled' ?
...

            {
                  ...
                  <TouchableOpacity 
                  onPress={() => navigation.navigate("NewTravelHistoryImageScreen", )}
                  style={{ 
                      alignItems:'center', 
                      flexDirection:'row', 
                      paddingVertical:5,
        ...
        {refused === 'refused' ?
...

          {
...

            {
                  ...
                  <TouchableOpacity 
                  onPress={() => navigation.navigate("NewDecisionLetterImageScreen", )}
                  style={{ 
                      alignItems:'center', 
                      flexDirection:'row', 
                      paddingVertical:5,
