...
const FathersDeathCertificateImageScreen = ({navigation}) => {
  ...
  const uploadMedia = async() => {
    ...
    try {
        ...
        await updateDoc(doc(db, "visa", visaId), {
           ...
           fathersDeathCertificateImage : url,
        ...
        Alert.alert("Fathers death certificate has been uploaded successfully!!!")
  ...
  const deleteImage = () => {
    ...
    deleteObject(deleteRef).then(async() => {
        ...
        await updateDoc(visaRef, {
          fathersDeathCertificateImage: deleteField()
        });
  ...
  return (
    <View style={{flex:1, alignItems:'center', justifyContent:'space-between', flexDirection:'column', padding:20}}>
        ...
        <View style={{width:'100%', alignItems:'center', flexDirection:'row', justifyContent:'space-between'}}>
            ...
            <Text style={{fontSize:18, fontWeight:'bold', color:COLORS.main, marginRight:10}}>Fathers Death Certificate</Text>
        </View>
...
export default FathersDeathCertificateImageScreen
