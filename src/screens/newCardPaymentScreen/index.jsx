...
export default function NewCardPaymentScreen({ navigation }) {
...
//   } = useForm({ defaultValues: InspectionStore.useState((s) => s) });
  ...
  const onSubmit = (data) => {
    ...
    navigation.navigate("NewPaymentSuccessfulScreen");
  };
    ...
    <ScrollView style={styles.container}>
      ...
      {value === 'transfer' &&
              (
                ...
                <Button
                onPress={() => navigation.navigate('NewPaymentSuccessfulScreen')}
                mode="outlined"
