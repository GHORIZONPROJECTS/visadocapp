...
const NewCompanyIntroductionImageScreen = ({navigation}) => {
  ...
  const uploadMedia = async() => {
    ...
    try {
        ...
        Alert.alert("Company introduction letter has been uploaded successfully!!!")
  ...
  return (
    <View style={{flex:1, alignItems:'center', justifyContent:'space-between', flexDirection:'column', padding:20}}>
        ...
        <View style={{width:'100%', alignItems:'center', flexDirection:'row', justifyContent:'space-between'}}>
            ...
            <Text style={{fontSize:18, fontWeight:'bold', color:COLORS.main, marginRight:10}}>Company Introduction Letter</Text>
        </View>
...
export default NewCompanyIntroductionImageScreen
