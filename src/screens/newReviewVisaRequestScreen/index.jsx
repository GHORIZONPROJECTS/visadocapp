...
export default function NewReviewVisaRequestScreen({navigation}) {
...
// visa application
  ...
  const handleMyReviews = () => {
      navigation.navigate("NewServiceChargeScreen")
  }
  ...
  return (
        <View style={{flex:1}}>
            ...
            <Text style={{fontSize:18, color:'black', marginLeft: 30, fontWeight:'bold'}}>Review Visa Application</Text>  
            ...
            <Pressable onPress = {handleMyReviews}  style = {{ backgroundColor : 'brown', width : '100%', alignItems : 'center', justifyContent : 'center',paddingVertical : 20, flexDirection : 'row',}}>
                <Text style={{color : 'white', fontSize : 18, marginRight : 10}}>Submit Application</Text>
