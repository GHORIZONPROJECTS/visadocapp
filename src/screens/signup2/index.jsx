...
import { createUserWithEmailAndPassword, sendEmailVerification, updateProfile, sendSignInLinkToEmail, signOut, getAuth  } from 'firebase/auth';
      ...
      .then(() => {
        ...
        sendEmailVerification(auth.currentUser, actionCodeSettings
          ...
          .then(() => {
            ...
            alert(`Email verification sent to ${email}, verify email and login `)
      ...
      <SafeAreaView style = {{paddingHorizontal : 20}}>
          ...
          <View style={{flexDirection : 'row', alignItems : 'center'}}>
              ...
              <View style = {{width : '100%', height : '200', alignItems : 'center', justifyContent : 'space-between', flexDirection : 'column', marginVertical : 10}}>
                  ...
                  <Text style= {{ fontSize : 16, color : 'lightgray'}}>Test sign up</Text>
              </View>
