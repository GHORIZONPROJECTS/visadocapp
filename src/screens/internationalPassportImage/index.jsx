...
const InternationalPassportImageScreen = ({navigation}) => {
  ...
  const uploadMedia = async() => {
    ...
    try {
        ...
        Alert.alert("International passport data page has been uploaded successfully!!!")
  ...
  return (
    <View style={{flex:1, alignItems:'center', justifyContent:'space-between', flexDirection:'column', padding:20}}>
        ...
        <View style={{width:'100%', alignItems:'center', flexDirection:'row', justifyContent:'space-between'}}>
            ...
            <Text style={{fontSize:18, fontWeight:'bold', color:COLORS.main, marginRight:10}}>International Passport Data Page</Text>
        </View>
...
//         Alert.alert("International Passport page has been uploaded successfully!!!")
...
//         <View style={{width:'100%', alignItems:'center', flexDirection:'row', justifyContent:'space-between'}}>
//             <BackArrow onPress={() => navigation.goBack()}/>
//             <Text style={{fontSize:18, fontWeight:'bold', color:COLORS.main, marginRight:10}}>International Passport Page</Text>
//         </View>
