...
const NewTravelHistoryImageScreen = ({navigation}) => {
  ...
  const uploadMedia = async() => {
    ...
    try {
        ...
        Alert.alert("Travel History Data page has been uploaded successfully!!!")
  ...
  return (
    <View style={{flex:1, alignItems:'center', justifyContent:'space-between', flexDirection:'column', padding:20}}>
        ...
        <View style={{width:'100%', alignItems:'center', flexDirection:'row', justifyContent:'space-between'}}>
            ...
            <Text style={{fontSize:18, fontWeight:'bold', color:COLORS.main, marginRight:10}}>Travel History Data Page</Text>
        </View>
        ...
        <View style={{width:'100%', alignItems:'center', justifyContent:'center', paddingBottom:100}}>
          ...
          {url && 
            ...
            <Pressable 
            onPress={() => navigation.navigate("NewTravelHistoryScreen")}
            style={{ 
                alignItems:'center', 
                flexDirection:'row', 
                padding:10, 
...
export default NewTravelHistoryImageScreen
