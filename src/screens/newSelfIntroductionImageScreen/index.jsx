...
const NewSelfIntroductionImageScreen = ({navigation}) => {
  ...
  const uploadMedia = async() => {
    ...
    try {
        ...
        Alert.alert("Self Introduction image has been uploaded successfully!!!")
  ...
  const deleteImage = () => {
    ...
    deleteObject(deleteRef).then(async() => {
        ...
        setUrl(null)
        // navigation.navigate("SelfIntroductionImageScreen")
...
export default NewSelfIntroductionImageScreen
