                ...
                <View style={{flexDirection:'row'}}>

                  {
                      ...
                      <TouchableOpacity 
                          ...
                          <TouchableOpacity 
                          onPress={() => navigation.navigate("InternationalPassportImageScreen")}
                          style={{ 
                              alignItems:'center', 
                              flexDirection:'row', 
                              paddingVertical:5,
...

            {
                ...
                {visaData.birthCertificateImage 
                      ...
                      <TouchableOpacity 
                          ...
                          <TouchableOpacity 
                          onPress={() => navigation.navigate("BirthCertificateImageScreen")}
                          style={{ 
                              alignItems:'center', 
                              flexDirection:'row', 
                              paddingVertical:5,
...
//       // if( visaData.internationalPassport === 'available' && visaData.internationalPassportImage === "" ){

//       //   return setErrorInternationalPassport('Field is required');
...
//                           <FontAwesome name="check-circle" size={20} color='green'/>
//                           <Text style={{marginLeft:5, color:'black'}}>Uploaded International Passport</Text>
...
//                     <FontAwesome name="check-circle" size={20} color='green'/>
//                     <Text style={{marginLeft:5, color:'black'}}>Uploaded Birth Certificate</Text>
...
//                     <FontAwesome name="check-circle" size={20} color='green'/>
//                     <Text style={{marginLeft:5, color:'black'}}>Uploaded Leave Approval Letter</Text>
...
//                       <Text style={{color:'red', fontSize:10, marginVertical:5}}> {errorLeaveApprovalLetter}</Text>
...
//                       <FontAwesome name="check-circle" size={20} color='green'/>
//                       <Text style={{marginLeft:5, color:'black'}}>Uploaded Marriage Certificate</Text>
...
//                       <FontAwesome name="check-circle" size={20} color='green'/>
//                       <Text style={{marginLeft:5, color:'black'}}>Uploaded Passport Photograph</Text>
...
//                       <FontAwesome name="check-circle" size={20} color='green'/>
//                       <Text style={{marginLeft:5, color:'black'}}>School Credentials</Text>
...
//                       <FontAwesome name="check-circle" size={20} color='green'/>
//                       <Text style={{marginLeft:5, color:'black'}}>Uploaded Self Introduction</Text>
...
//                       <FontAwesome name="check-circle" size={20} color='green'/>
//                       <Text style={{marginLeft:5, color:'black'}}>Uploaded Company Introduction</Text>
...
//                       <FontAwesome name="check-circle" size={20} color='green'/>
//                       <Text style={{marginLeft:5, color:'black'}}>Uploaded Statement of Account</Text>
...
//                     <FontAwesome name="check-circle" size={20} color='green'/>
//                     <Text style={{marginLeft:5, color:'black'}}>Uploaded Employment Letter</Text>
