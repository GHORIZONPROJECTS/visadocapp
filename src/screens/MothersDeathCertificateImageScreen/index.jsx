...
const MothersDeathCertificateImageScreen = ({navigation}) => {
  ...
  const uploadMedia = async() => {
    ...
    try {
        ...
        await updateDoc(doc(db, "visa", visaId), {
           ...
           mothersDeathCertificateImage : url,
        ...
        Alert.alert("Mothers Death Certificate has been uploaded successfully!!!")
  ...
  const deleteImage = () => {
    ...
    deleteObject(deleteRef).then(async() => {
        ...
        await updateDoc(visaRef, {
          mothersDeathCertificateImage: deleteField()
        });
  ...
  return (
    <View style={{flex:1, alignItems:'center', justifyContent:'space-between', flexDirection:'column', padding:20}}>
        ...
        <View style={{width:'100%', alignItems:'center', flexDirection:'row', justifyContent:'space-between'}}>
            ...
            <Text style={{fontSize:18, fontWeight:'bold', color:COLORS.main, marginRight:10}}>Mothers Death Certificate</Text>
        </View>
...
export default MothersDeathCertificateImageScreen
