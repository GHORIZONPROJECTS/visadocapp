...
export default function NewDocumentsAvailableScreen({ navigation }) {
  ...
  const [errorEmploymentLetter, setErrorEmploymentLetter] = useState("")
    ...
    navigation.navigate("NewReviewVisaRequestScreen");
                  ...
                  <Text style={{marginHorizontal:5, fontSize:11}}>Company Introduction</Text>
                    ...
                    {visaData.companyIntroductionImage 
                      ...
                      <TouchableOpacity 
                          ...
                          <TouchableOpacity 
                          onPress={() => navigation.navigate("NewCompanyIntroductionImageScreen")}
                          style={{ 
                              alignItems:'center', 
                              flexDirection:'row', 
                              paddingVertical:5,
...

                {
                    ...
                    {visaData.employmentLetterImage 
                      ...
                      <TouchableOpacity 
                          ...
                          <TouchableOpacity 
                          onPress={() => navigation.navigate("NewEmploymentLetterImageScreen")}
                          style={{ 
                              alignItems:'center', 
                              flexDirection:'row', 
                              paddingVertical:5,
