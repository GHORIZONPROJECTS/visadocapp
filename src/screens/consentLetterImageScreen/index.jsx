...
const ConsentLetterImageScreen = ({navigation}) => {
  ...
  const uploadMedia = async() => {
    ...
    try {
        ...
        Alert.alert(" File is been uploaded successfully!!!")
  ...
  console.log('my image uploaded: ',url)

  useEffect(() => {
    updateDoc(doc(db, "visa", visaId), {

      consentLetterImage : url,
...
// console.log('uploaded image: ', consent)

  return (

    <>
      {ImageLoading ?<NowLoading />: ""}
      <View style={{flex:1, alignItems:'center', justifyContent:'space-between', flexDirection:'column', padding:20}}>

<View style={{width:'100%', alignItems:'center', flexDirection:'row', justifyContent:'space-between'}}>
    <BackArrow onPress={() => navigation.goBack()}/>
    <Text style={{fontSize:18, fontWeight:'bold', color:COLORS.main, marginRight:10}}>Consent / Birth Certificate</Text>
</View>
...
<View style={{width:300, height:400, alignItems:'center', position:'relative'}}>
    ...
    :
        ...
        <View style={{width:'100%', height:'100%',alignItems:"center", justifyContent:'center'}}>
            <Text style={{color:'red'}}>4mb file Maximum</Text>
        </View>
...
<View style={{width:'100%', alignItems:'center', justifyContent:'center', paddingBottom:100}}>
  ...
  {url && 
    ...
    <Pressable 
    onPress={() => navigation.navigate("MaritalAndEmploymentScreen")}
    style={{ 
        alignItems:'center', 
        flexDirection:'row', 
        padding:10, 
...
export default ConsentLetterImageScreen
